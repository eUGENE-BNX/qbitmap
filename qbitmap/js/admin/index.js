...
const AdminPanel = {
  ...
  switchTab(tabName) {
    ...
    // Load city cameras when switching to city-cameras tab
    if (tabName === 'city-cameras') {
...
// ==================== CITY CAMERAS ====================
  ...
  async loadCityCameras() {
    try {
      ...
      console.error('City cameras load error:', err);
    }
  },
  ...
  async deleteCityCamera() {
    ...
    try {
      const res = await fetch(`${QBitmapConfig.api.admin}/cameras/city/${this.editingCityCameraId}`, {
