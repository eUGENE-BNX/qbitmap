...
const VideoMessage = {
  ...
  openMessagePopup(props, coordinates) {
      ...
      <div class="video-msg-popup" data-message-id="${esc(messageId)}">
        <div class="video-msg-popup-header">
          ...
          <div class="video-msg-share-buttons">
            ...
            <button class="video-msg-share-btn twitter" data-action="share-twitter" title="X'te Paylas">
            ...
            <button class="video-msg-share-btn whatsapp" data-action="share-whatsapp" title="WhatsApp'ta Paylas">
        ...
        <div class="video-msg-popup-meta">
          ...
          ${aiDescription ? `<div class="video-msg-popup-ai-description"><strong>AI:</strong> ${esc(aiDescription)}</div>` : ''}
        ...
        <div class="video-msg-popup-footer">
          <button class="video-msg-popup-action delete" data-action="delete">Sil</button>
        </div>
        ` : ''}
      </div>
    `;
    ...
    setTimeout(() => {
      ...
      const facebookBtn = popupEl.querySelector('[data-action="share-facebook"]');
      if (facebookBtn) facebookBtn.onclick = () => this.shareOnFacebook(messageId);
